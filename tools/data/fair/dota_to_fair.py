...
# python tools/data/fair/dota_to_fair.py ./test_dir/oriented_rcnn_r101_dcn_pafpnwo_adapter_ce_fair_ms_traintest0.8/Task1_results ./fair_res/test1 ./data/fair1m_ms/test/images
