...
from .label_smooth_cross_entropy_loss import LabelSmoothCrossEntropyLoss
from .label_smooth_focal_loss import LabelSmoothFocalLoss

__all__ = [
    'GDLoss', 'GDLoss_v1', 'KFLoss', 'ConvexGIoULoss', 'BCConvexGIoULoss',
    'KLDRepPointsLoss', 'SmoothFocalLoss', 'RotatedIoULoss',
    'SpatialBorderLoss', 'LabelSmoothCrossEntropyLoss', 'LabelSmoothFocalLoss'
]
